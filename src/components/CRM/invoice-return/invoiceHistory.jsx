  ...
  return (
    <>
      <div className="createNewInvoice-history-container">
        <div className="createNewInvoice-statusChange-container">
          <div className="createNewInvoice-status-head">
            <svg
              className="createNewInvoice-status-logo"
          ...
          {statusChange.length > 0 ? (
            <div className="createNewInvoice-status-detailes">
              {statusChange.map((ele, ind) => (
                <nav key={ind}>
                  <svg
                    className="createNewInvoice-history-profile-logo"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
                    fill="none"
                  >
        ...
        <div className="createNewInvoice-statusChange-container">
          <div className="createNewInvoice-status-head">
            <svg
              className="createNewInvoice-history-mail-logo"
              xmlns="http://www.w3.org/2000/svg"
              width="20"
              height="16"
              viewBox="0 0 20 16"
