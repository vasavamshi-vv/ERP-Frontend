...
export default function invoiceComment() {
  ...
  return (
    <div className="createNewDeliveryReturn-comment-container">
      ...
      <form>
        <input
          id="createNewDeliveryReturnComment"
          type="text"
      ...
      <div className="createNewDeliveryReturn-comment-brline"></div>

      <div className="createNewDeliveryReturn-showarea">
        {commentData.length > 0 &&
          commentData.map((ele, ind) => (
            <div key={[-ind]} className="createNewDeliveryReturn-message-container">
              <svg
                className="createNewDeliveryReturn-comment-profile-logo"
