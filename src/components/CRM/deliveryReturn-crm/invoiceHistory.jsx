  ...
  return (
    <>
      <div className="createDeliveryReturn-history-container">
        <div className="createDeliveryReturn-statusChange-container">
          <div className="createDeliveryReturn-status-head">
            <svg
              className="createDeliveryReturn-status-logo"
          ...
          {statusChange.length > 0 ? (
            <div className="createDeliveryReturn-status-detailes">
              {statusChange.map((ele, ind) => (
                <nav key={ind}>
                  <svg
                    className="createDeliveryReturn-history-profile-logo"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
                    fill="none"
                  >
        ...
        <div className="createDeliveryReturn-statusChange-container">
          <div className="createDeliveryReturn-status-head">
            <svg
              className="createDeliveryReturn-history-mail-logo"
              xmlns="http://www.w3.org/2000/svg"
              width="20"
              height="16"
              viewBox="0 0 20 16"
