  ...
  return (
    <>
      <div className="cerateNewStock-history-container">
        <div className="cerateNewStock-statusChange-container">
          <div className="cerateNewStock-status-head">
            <svg
              className="cerateNewStock-status-logo"
          ...
          {statusChange.length > 0 ? (
            <div className="cerateNewStock-status-detailes">
              {statusChange.map((ele, ind) => (
                <nav key={ind}>
                  <svg
                    className="cerateNewStock-history-profile-logo"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
                    fill="none"
                  >
        ...
        <div className="cerateNewStock-statusChange-container">
          <div className="cerateNewStock-status-head">
            <svg
              className="cerateNewStock-history-mail-logo"
              xmlns="http://www.w3.org/2000/svg"
              width="20"
              height="16"
              viewBox="0 0 20 16"
