  ...
  return (
    <div className="createNewInvoice-attachment-container">
      <div className="createNewInvoice-upload-container">
        ...
        />
        <div
          className="createNewInvoice-upload-btn"
      ...
      {uploadedFiles.length > 0 && (
        <>
          <nav className="createNewInvoice-attached-files">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="18"
              height="18"
          ...
          {uploadedFiles.map((file, index) => (
            <div key={`upload-${index}`} className="createNewInvoice-file-item">
              <nav>{file.name}</nav>
      ...
      {backendFiles.length > 0 && (
        <>
          ...
          {backendFiles.map((file, index) => (
            <div
              key={`backend-${index}`}
              className="createNewInvoice-file-item"
            >
              <nav>{file.name}</nav>
              <div className="createNewInvoice-file-actions">
                <a
