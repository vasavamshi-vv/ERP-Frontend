...
export default function stockAttachment({ inputDisable }) {
    ...
    <div className="cerateNewStock-attachment-container">
      <div className="cerateNewStock-upload-container">
        <input
          ...
          multiple
        />
        <div className="cerateNewStock-upload-btn" onClick={handleUploadClick}>
          <svg
      ...
      {uploadedFiles.length > 0 && (
        <>
          <nav className="cerateNewStock-attached-files">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="18"
              height="18"
          ...
          {uploadedFiles.map((file, index) => (
            <div key={`upload-${index}`} className="cerateNewStock-file-item">
              <nav>{file.name}</nav>
      ...
      {backendFiles.length > 0 && (
        <>
          ...
          {backendFiles.map((file, index) => (
            <div key={`backend-${index}`} className="cerateNewStock-file-item">
              <nav>{file.name}</nav>
              <div className="cerateNewStock-file-actions">
                <a
                  href={file.url}
