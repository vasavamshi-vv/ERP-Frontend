      ...
      const fetchCandidate = async () => {
        try {
          ...
          const response = await axios.get(
            `http://13.239.191.236:8000/api/onboarding/${candidateId}/`,
            {
              headers: {
  ...
  useEffect(() => {
    const fetchDepartmentsAndBranches = async () => {
      try {
        ...
        // Fetch branches
        const branchResponse = await axios.get("http://13.239.191.236:8000/api/branches/", {
          headers: {
            Authorization: `Token ${token}`,
            "Content-Type": "application/json",
          },
    ...
    const fetchRoles = async () => {
      ...
      try {
        const roleResponse = await axios.get(
          `http://13.239.191.236:8000/api/roles/?department=${formData.department}`,
          {
            headers: {
              Authorization: `Token ${token}`,
              "Content-Type": "application/json",
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = candidateId
        ...
        : await axios.post(
          "http://13.239.191.236:8000/api/onboarding/",
          formDataToSend,
          config
        );
