...
export default function NewProductUOM({
  ...
  useEffect(() => {
    const fetchUOMs = async () => {
      try {
        ...
        const res = await axios.get("http://13.239.191.236:8000/api/uoms/", {
          headers: {
    ...
    try {
      ...
      if (newProductUOM) {
        ...
        const res = await axios.post(
          "http://13.239.191.236:8000/api/uoms/",
          {
        ...
        const res = await axios.put(
          `http://13.239.191.236:8000/api/uoms/${selectedUOM.id}/`,
          {
            name: UOMData.uom_name,
            items: parseInt(UOMData.items),
            description: UOMData.description || null,
  ...
  const handleDeleteUOM = async () => {
    ...
    try {
      ...
      await axios.delete(`http://13.239.191.236:8000/api/uoms/${selectedUOM.id}/`, {
        headers: {
          Authorization: `Token ${token}`,
        },
      });
