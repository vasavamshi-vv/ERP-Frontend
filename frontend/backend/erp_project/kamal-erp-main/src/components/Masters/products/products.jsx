...
export default function products() {
    ...
    const fetchData = async () => {
      try {
        ...
        const [productsResponse, categoriesResponse, suppliersResponse] = await Promise.all([
          axios.get("http://13.239.191.236:8000/api/products/", { headers }),
          axios.get("http://13.239.191.236:8000/api/categories/", { headers }),
          axios.get("http://13.239.191.236:8000/api/suppliers/", { headers }),
        ]);
  ...
  const deleteProduct = async (id) => {
    ...
    if (okDel) {
      try {
        ...
        await axios.delete(`http://13.239.191.236:8000/api/products/${id}/`, {
  ...
  const showEditProduct = async (id) => {
    try {
      ...
      const response = await axios.get(`http://13.239.191.236:8000/api/products/${id}/`, {
        headers: { Authorization: `Token ${token}` },
      });
      ...
      setEditProduct({
        ...
        image: productData.image ? `http://13.239.191.236:8000/${productData.image}` : "",
