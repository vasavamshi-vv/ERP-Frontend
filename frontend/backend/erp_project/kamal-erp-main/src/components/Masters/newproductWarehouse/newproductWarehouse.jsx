...
export default function NewProductWarehouse({
  ...
  useEffect(() => {
    const fetchWarehouses = async () => {
      try {
        ...
        const res = await axios.get("http://13.239.191.236:8000/api/warehouses/", {
          headers: {
    ...
    try {
      ...
      if (newproductWarehouse) {
        ...
        const res = await axios.post(
          "http://13.239.191.236:8000/api/warehouses/",
          {
        ...
        const res = await axios.put(
          `http://13.239.191.236:8000/api/warehouses/${selectedWarehouse.id}/`,
          {
            name: WarehouseData.warehouse_name,
            location: WarehouseData.location,
            manager_name: WarehouseData.manager_name || null,
  ...
  const handleDeleteWarehouse = async () => {
    ...
    try {
      ...
      await axios.delete(`http://13.239.191.236:8000/api/warehouses/${selectedWarehouse.id}/`, {
        headers: {
          Authorization: `Token ${token}`,
        },
      });
