...
export default function NewProductSupplier({
  ...
  useEffect(() => {
    const fetchSuppliers = async () => {
      try {
        ...
        const res = await axios.get("http://13.239.191.236:8000/api/suppliers/", {
          headers: {
    ...
    try {
      ...
      if (newproductSupplier) {
        ...
        const res = await axios.post(
          "http://13.239.191.236:8000/api/suppliers/",
          {
        ...
        const res = await axios.put(
          `http://13.239.191.236:8000/api/suppliers/${selectedSupplier.id}/`,
          {
            name: SupplierData.supplier_name,
            contact_person: SupplierData.contact_person,
            phone_number: SupplierData.phone_number,
  ...
  const handleDeleteSupplier = async () => {
    ...
    try {
      ...
      await axios.delete(`http://13.239.191.236:8000/api/suppliers/${selectedSupplier.id}/`, {
        headers: {
          Authorization: `Token ${token}`,
        },
      });
