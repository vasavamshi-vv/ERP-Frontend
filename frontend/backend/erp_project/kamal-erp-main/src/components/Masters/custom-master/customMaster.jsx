...
export default function CustomMaster() {
  ...
  useEffect(() => {
    const fetchCustomers = async () => {
      ...
      setIsLoading(true);
      try {
        const response = await axios.get("http://13.239.191.236:8000/api/customers/", {
          headers: {
  ...
  useEffect(() => {
    const fetchSalesReps = async () => {
      ...
      try {
        const response = await axios.get("http://13.239.191.236:8000/api/customers/summary/", {
          headers: {
            Authorization: `Token ${token}`,
            "Content-Type": "application/json",
          },
  ...
  const deleteCustomer = async (id) => {
    ...
    try {
      await axios.delete(`http://13.239.191.236:8000/api/customers/${id}/`, {
        headers: {
          Authorization: `Token ${token}`,
          "Content-Type": "application/json",
        },
  ...
  const showEditCustomer = async (id) => {
    ...
    try {
      const response = await axios.get(`http://13.239.191.236:8000/api/customers/${id}/`, {
        headers: {
          Authorization: `Token ${token}`,
          "Content-Type": "application/json",
        },
