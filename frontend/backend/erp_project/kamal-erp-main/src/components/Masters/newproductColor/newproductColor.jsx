...
export default function NewProductColor({
  ...
  useEffect(() => {
    const fetchColors = async () => {
      try {
        ...
        const res = await axios.get("http://13.239.191.236:8000/api/colors/", {
          headers: {
    ...
    try {
      ...
      if (newproductColor) {
        ...
        const res = await axios.post(
          "http://13.239.191.236:8000/api/colors/",
        ...
        const res = await axios.put(
          `http://13.239.191.236:8000/api/colors/${selectedColor.id}/`,
  ...
  const handleDeleteColor = async () => {
    ...
    try {
      ...
      await axios.delete(`http://13.239.191.236:8000/api/colors/${selectedColor.id}/`, {
        headers: {
          Authorization: `Token ${token}`,
        },
      });
