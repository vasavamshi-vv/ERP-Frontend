...
//         "http://13.239.191.236:8000/api/categories/",
...
//         `http://13.239.191.236:8000/api/categories/${selectedId}/`,
...
export default function NewProductCategory({
  ...
  useEffect(() => {
    const fetchCategories = async () => {
      try {
        ...
        const res = await axios.get("http://13.239.191.236:8000/api/categories/", {
          headers: {
  ...
  const handleCategorydataSubmit = async (e) => {
    ...
    try {
      ...
      if (newproductCategory) {
        ...
        const res = await axios.put(
          `http://13.239.191.236:8000/api/categories/${selectedCategory.id}/`,
          { name: CategoryData.update_category_name },
          {
            headers: {
              Authorization: `Token ${token}`,
  ...
  const handleDeleteCategory = async () => {
    ...
    try {
      ...
      await axios.delete(`http://13.239.191.236:8000/api/categories/${selectedCategory.id}/`, {
        headers: {
          Authorization: `Token ${token}`,
        },
      });
