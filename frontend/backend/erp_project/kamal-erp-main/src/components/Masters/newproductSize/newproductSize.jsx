...
export default function NewProductSize({
  ...
  useEffect(() => {
    const fetchSizes = async () => {
      try {
        ...
        const res = await axios.get("http://13.239.191.236:8000/api/sizes/", {
          headers: {
    ...
    try {
      ...
      if (newproductSize) {
        ...
        const res = await axios.post(
          "http://13.239.191.236:8000/api/sizes/",
        ...
        const res = await axios.put(
          `http://13.239.191.236:8000/api/sizes/${selectedSize.id}/`,
  ...
  const handleDeleteSize = async () => {
    ...
    try {
      ...
      await axios.delete(`http://13.239.191.236:8000/api/sizes/${selectedSize.id}/`, {
        headers: {
          Authorization: `Token ${token}`,
        },
      });
