...
//         let response;
//         try {
//           response = await axios.get("http://13.239.191.236:8000/api/onboarding/?department=6", {
//             headers: {
...
//           response = await axios.get("http://13.239.191.236:8000/api/onboarding/", {
//             headers: {
//               Authorization: `Token ${token}`,
//               "Content-Type": "application/json",
//             },
    ...
    try {
      ...
      if (editShowAddCustom && editAddCustomData.id) {
        response = await axios.put(
          `http://13.239.191.236:8000/api/customers/${editAddCustomData.id}/`,
          formData,
          config
        );
        ...
        response = await axios.post(
          "http://13.239.191.236:8000/api/customers/",
          formData,
          config
        );
