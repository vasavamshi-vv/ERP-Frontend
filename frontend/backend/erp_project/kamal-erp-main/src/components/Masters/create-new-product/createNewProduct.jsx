    ...
    const fetchDropdowns = async () => {
      try {
        ...
        const [
          ...
          fetchWithErrorHandling("http://13.239.191.236:8000/api/categories/", "categories"),
          fetchWithErrorHandling("http://13.239.191.236:8000/api/tax-codes/", "tax_codes"),
          fetchWithErrorHandling("http://13.239.191.236:8000/api/uoms/", "uoms"),
          fetchWithErrorHandling("http://13.239.191.236:8000/api/warehouses/", "warehouses"),
          fetchWithErrorHandling("http://13.239.191.236:8000/api/sizes/", "sizes"),
          fetchWithErrorHandling("http://13.239.191.236:8000/api/colors/", "colors"),
          fetchWithErrorHandling("http://13.239.191.236:8000/api/suppliers/", "suppliers"),
          fetchWithErrorHandling("http://13.239.191.236:8000/api/products/", "products"),
        ]);
    ...
    try {
      ...
      if (editNewProduct && newProductData.id) {
        ...
        response = await axios.put(
          `http://13.239.191.236:8000/api/products/${newProductData.id}/`,
          formData,
          { headers }
        );
        ...
        // Create new product
        response = await axios.post("http://13.239.191.236:8000/api/products/", formData, { headers });
