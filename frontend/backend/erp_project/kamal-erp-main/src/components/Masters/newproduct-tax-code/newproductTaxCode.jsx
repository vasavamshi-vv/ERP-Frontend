...
export default function NewProductTaxCode({
  ...
  useEffect(() => {
    const fetchTaxCodes = async () => {
      try {
        ...
        const res = await axios.get("http://13.239.191.236:8000/api/tax-codes/", {
          headers: {
    ...
    try {
      ...
      if (newproduct_tax_code) {
        ...
        const res = await axios.post(
          "http://13.239.191.236:8000/api/tax-codes/",
          {
        ...
        const res = await axios.put(
          `http://13.239.191.236:8000/api/tax-codes/${selectedTaxCode.id}/`,
          {
            name: TaxCodeData.tax_name,
            percentage: parseFloat(TaxCodeData.tax_percentage),
            description: TaxCodeData.description || null,
  ...
  const handleDeleteTaxCode = async () => {
    ...
    try {
      ...
      await axios.delete(`http://13.239.191.236:8000/api/tax-codes/${selectedTaxCode.id}/`, {
        headers: {
          Authorization: `Token ${token}`,
        },
      });
