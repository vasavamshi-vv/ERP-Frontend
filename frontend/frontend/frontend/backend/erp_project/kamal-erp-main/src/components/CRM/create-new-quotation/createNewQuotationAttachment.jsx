    ...
    <div className="newQuotation-attachment-container">
      <div className="newQuotation-upload-container">
        <input
          ...
          multiple
        />
        <div className="newQuotation-upload-btn" onClick={handleUploadClick}>
          <svg
      ...
      {uploadedFiles.length > 0 && (
        <>
          <nav className="newQuotation-attached-files">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="18"
              height="18"
          ...
          {uploadedFiles.map((file, index) => (
            <div key={`upload-${index}`} className="newQuotation-file-item">
              <nav>{file.name}</nav>
      ...
      {backendFiles.length > 0 && (
        <>
          ...
          {backendFiles.map((file, index) => (
            <div key={`backend-${index}`} className="newQuotation-file-item">
              <nav>{file.name}</nav>
              <div className="newQuotation-file-actions">
                <a
                  href={file.url}
