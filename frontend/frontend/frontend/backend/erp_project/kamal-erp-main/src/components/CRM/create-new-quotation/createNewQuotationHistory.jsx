...
export default function createNewQuotationHistory() {
  ...
  return (
    <>
      <div className="newQuotation-history-container">
        <div className="newQuotation-statusChange-container">
          <div className="newQuotation-status-head">
            <svg
              className="newQuotation-status-logo"
          ...
          {statusChange.length > 0 ? (
            <div className="newQuotation-status-detailes">
              {statusChange.map((ele, ind) => (
                <nav key={ind}>
                  <svg
                    className="newQuotation-history-profile-logo"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
                    fill="none"
                  >
        ...
        <div className="newQuotation-statusChange-container">
          <div className="newQuotation-status-head">
            <svg
              className="newQuotation-history-mail-logo"
              xmlns="http://www.w3.org/2000/svg"
              width="20"
              height="16"
              viewBox="0 0 20 16"
