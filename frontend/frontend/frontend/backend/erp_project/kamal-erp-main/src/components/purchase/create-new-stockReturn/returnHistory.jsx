...
export default function returnHistory() {
  ...
  return (
    <>
      <div className="createNewReturn-history-container">
        <div className="createNewReturn-statusChange-container">
          <div className="createNewReturn-status-head">
            <svg
              className="createNewReturn-status-logo"
          ...
          {statusChange.length > 0 ? (
            <div className="createNewReturn-status-detailes">
              {statusChange.map((ele, ind) => (
                <nav key={ind}>
                  <svg
                    className="createNewReturn-history-profile-logo"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
                    fill="none"
                  >
        ...
        <div className="createNewReturn-statusChange-container">
          <div className="createNewReturn-status-head">
            <svg
              className="createNewReturn-history-mail-logo"
              xmlns="http://www.w3.org/2000/svg"
              width="20"
              height="16"
              viewBox="0 0 20 16"
