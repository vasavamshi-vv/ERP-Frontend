...
export default function stockComment() {
  ...
  return (
    <div className="cerateNewStock-comment-container">
      ...
      <div className="cerateNewStock-comment-brline"></div>

      <div className="cerateNewStock-showarea">
        {commentData.length > 0 &&
          commentData.map((ele, ind) => (
            <div key={[-ind]} className="cerateNewStock-message-container">
              <svg
                className="cerateNewStock-comment-profile-logo"
