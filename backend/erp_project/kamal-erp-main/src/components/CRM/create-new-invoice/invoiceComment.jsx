...
export default function invoiceComment() {
  ...
  return (
    <div className="createNewInvoice-comment-container">
      ...
      <div className="createNewInvoice-comment-brline"></div>

      <div className="createNewInvoice-showarea">
        {commentData.length > 0 &&
          commentData.map((ele, ind) => (
            <div key={[-ind]} className="createNewInvoice-message-container">
              <svg
                className="createNewInvoice-comment-profile-logo"
