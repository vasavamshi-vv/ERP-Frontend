...
export default function createNewSalesHistory() {
  ...
  return (
    <>
      <div className="createNewSales-history-container">
        <div className="createNewSales-statusChange-container">
          <div className="createNewSales-status-head">
            <svg
              className="createNewSales-status-logo"
          ...
          {statusChange.length > 0 ? (
            <div className="createNewSales-status-detailes">
              {statusChange.map((ele, ind) => (
                <nav key={ind}>
                  <svg
                    className="createNewSales-history-profile-logo"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
                    fill="none"
                  >
        ...
        <div className="createNewSales-statusChange-container">
          <div className="createNewSales-status-head">
            <svg
              className="createNewSales-history-mail-logo"
              xmlns="http://www.w3.org/2000/svg"
              width="20"
              height="16"
              viewBox="0 0 20 16"
